 ...
 */
final class Version20230410161244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD table_id INT DEFAULT NULL, CHANGE time hour TIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP table_id, CHANGE hour time TIME NOT NULL');
    }
}
